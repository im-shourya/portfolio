...
//               style={{ fontSize: "clamp(70px,9vw,110px)", color: "rgba(242,239,230,.08)" }}
//             >
//               {yearCount}
//             </div>
...
const Hero = () => {
  ...
  return (
    <section id="hero" ref={heroRef} className="py-[156px] px-10 relative overflow-hidden">
      <HeroCanvas />
      ...
      <span className="grid grid-cols-1 md:grid-cols-[1fr_auto] items-end gap-6 md:gap-10 relative z-[1]">
        ...
        <span
          className="flex flex-col items-start gap-5 pb-1.5 opacity-0 relative z-[1]"
          style={{ animation: "fadeInUp .8s ease .9s forwards" }}
        >
          <span className="text-left md:text-right">
            <div
