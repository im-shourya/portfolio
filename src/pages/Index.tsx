...
// const Home = () => (
//   <Layout>
//     {/* Reduced top margin for mobile (mt-20) to pull content up */}
//     <section className="mt-20 sm:mt-32 lg:mt-40 mb-20 max-w-3xl px-4 sm:px-0">
//       <motion.div
//         initial={{ opacity: 0, y: 20 }}
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ duration: 0.6 }}
...
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ duration: 0.6, delay: 0.15 }}
//         className="text-base sm:text-lg font-light text-primary ml-1 sm:ml-36 mb-8 leading-relaxed"
//       >
//         <span className="uppercase tracking-widest text-xs font-semibold">
//           Computer Science and Engineering Student
//         </span>
...
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ duration: 0.6, delay: 0.3 }}
//         className="space-y-2 mb-12 ml-1 sm:ml-0"
//       >
//         <p className="text-sm font-light text-muted-foreground leading-relaxed max-w-[90%] sm:max-w-none">
//           Hello! I'm Shourya Parashar.{" "}
//           <strong className="font-semibold text-foreground">
//             Computer Science and Engineering student.
//           </strong>
...
//           <a
//             href="#"
//             className="gradient-border inline-flex items-center gap-2 px-6 py-3 sm:px-8 sm:py-4 text-sm sm:text-base font-medium text-foreground transition-all duration-300 hover:scale-105 active:scale-95"
//           >
//             Download CV
//             <span className="text-sm animate-float">↓</span>
//           </a>
