...
const timeline = [
  ...
  },
  {
    ...
    description: "Pursuing specialized coursework in Data Structures, Algorithms, and Software Engineering. Active member of technical clubs @ HackerRank Campus Crew - Technical and hackathons.",
