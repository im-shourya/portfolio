...
const projects = [
  {
    title: "NEXUS",
    description: "AI Powered Sports Platform India's Talent Discovery - Development",
    tech: ["Node.js", "Supbase" , "HTML" ,"CSS","React", "Python" , "Machine Learning"],
    link: "https://github.com/im-shourya/NEXUS",
  },
  {
    title: "KanbanFlow",
    description: "KanbanFlow is a single-page Kanban task manager.",
    tech: ["HTML" ,"CSS","React","TypeScript","Vite"],
    link: "https://github.com/im-shourya/KanbanFlow",
  },
  {
          ...
          >
            <SpotlightCard className="h-full">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                // Changed padding: p-5 on mobile, p-8 on desktop
                // Added active:scale-[0.98] for touch feedback
                className="p-5 sm:p-8 block group cursor-pointer h-full transition-transform duration-200 active:scale-[0.98]"
              >
